...
class RenderFlex extends MultiChildRenderObject {
  ...
  protected preformLayout(): void {
    ...
    const loosenedConstraint = this.constraint.loosen()

    // 공통
    this.children.forEach((child) => {
      child.layout(loosenedConstraint)
      ...
      crossAxisValue =
        this.crossAxisAlignment === "stretch"
          ? loosenedConstraint.getMax(this.crossAxis)
    ...
    this.children.forEach((child) => {
      ...
      child.layout(childConstraint.enforce(loosenedConstraint))
    })
  ...
  private getNonFlexItemConstraint() {
    ...
    switch (this.crossAxisAlignment) {
      case "stretch":
        ...
        break
      default:
        childConstraint = this.constraint.loosen()
    }

    return childConstraint.enforce(this.constraint.loosen())
  }
