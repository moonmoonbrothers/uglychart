...
export const Basic: Story = {
	args: {
		...
		height: '300px',
		code:
			dedent`import { Container, Align, Alignment } from '@moonmoonbrothers/flutterjs'\n\n\n` +
			BasicWidget,
		widget: Align({
			child: Container({
				width: 200,
...
export const ChildConstraintsBeLoosened: Story = {
	args: {
		...
		height: '300px',
		code:
			dedent`import { Container, Align, ConstrainedBox, Constraints } from '@moonmoonbrothers/flutterjs'\n\n\n` +
...
export const UnderUnconstrained: Story = {
	args: {
		...
		height: '300px',
		code:
			dedent`import { Container, Align, ConstraintsTransformBox, Alignment } from '@moonmoonbrothers/flutterjs'\n\n\n` +
...
export const WithFactorProps: Story = {
	args: {
		...
		height: '300px',
		code:
			dedent`import { Container, Align } from '@moonmoonbrothers/flutterjs'\n\n\n` +
